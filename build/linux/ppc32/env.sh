...
export _CPU_TYPE=_CPU_POWERPC
export _MACHINE=
export _CPU=ppc
export CPU_POWERPC=1
export CC=/opt/fsl-networking/QorIQ-SDK-V1.4/sysroots/i686-fsl_networking_sdk-linux/usr/bin/ppce500v2-fsl_networking-linux-gnuspe/powerpc-fsl_networking-linux-gnuspe-gcc
export CXX=/opt/fsl-networking/QorIQ-SDK-V1.4/sysroots/i686-fsl_networking_sdk-linux/usr/bin/ppce500v2-fsl_networking-linux-gnuspe/powerpc-fsl_networking-linux-gnuspe-g++
export LD=/opt/fsl-networking/QorIQ-SDK-V1.4/sysroots/i686-fsl_networking_sdk-linux/usr/bin/ppce500v2-fsl_networking-linux-gnuspe/powerpc-fsl_networking-linux-gnuspe-ld
export AR=/opt/fsl-networking/QorIQ-SDK-V1.4/sysroots/i686-fsl_networking_sdk-linux/usr/bin/ppce500v2-fsl_networking-linux-gnuspe/powerpc-fsl_networking-linux-gnuspe-ar
export RANLIB=/opt/fsl-networking/QorIQ-SDK-V1.4/sysroots/i686-fsl_networking_sdk-linux/usr/bin/ppce500v2-fsl_networking-linux-gnuspe/powerpc-fsl_networking-linux-gnuspe-ranlib
export NM=/opt/fsl-networking/QorIQ-SDK-V1.4/sysroots/i686-fsl_networking_sdk-linux/usr/bin/ppce500v2-fsl_networking-linux-gnuspe/powerpc-fsl_networking-linux-gnuspe-nm
export STRIP=/opt/fsl-networking/QorIQ-SDK-V1.4/sysroots/i686-fsl_networking_sdk-linux/usr/bin/ppce500v2-fsl_networking-linux-gnuspe/powerpc-fsl_networking-linux-gnuspe-strip
export OBJDUMP=/opt/fsl-networking/QorIQ-SDK-V1.4/sysroots/i686-fsl_networking_sdk-linux/usr/bin/ppce500v2-fsl_networking-linux-gnuspe/powerpc-fsl_networking-linux-gnuspe-objdump
export AS=/opt/fsl-networking/QorIQ-SDK-V1.4/sysroots/i686-fsl_networking_sdk-linux/usr/bin/ppce500v2-fsl_networking-linux-gnuspe/powerpc-fsl_networking-linux-gnuspe-as
