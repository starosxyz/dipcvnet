...
Json::Value PacketBase::ValueToJson(uint8_t value)
{
    char buffer[1024]={0};
...
Json::Value PacketBase::ValueToJson(uint16_t value)
{
    char buffer[1024]={0};
    snprintf(buffer,1024,"%d", value);
...
Json::Value PacketBase::ValueToJson(uint32_t value)
{
    CAWString str = U32ToStr(value);
    return Json::Value(str.c_str());
}

Json::Value PacketBase::ValueToJson(uint64_t value)
{
    CAWString str = U64ToStr(value);
    return Json::Value(str.c_str());
}

Json::Value PacketBase::ValueToJson(const CAWString &value)
{
...
************************************************************************/
Json::Value PacketBase::ValueToJson(bool boolvalue)
{
    if (boolvalue)
    {
...
* 2019/4/17  V1.0    夏章辉     创建
************************************************************************/
Json::Value PacketBase::IPv4ToJson(uint32_t ipv4addr)
{
    CAWInetAddr addr;
...
* 2019/4/17  V1.0    夏章辉     创建
************************************************************************/
Json::Value PacketBase::IPv6ToJson(uint8_t ipv6[128])
{
...
* 2019/4/17  V1.0    夏章辉     创建
************************************************************************/
Json::Value PacketBase::MacAddressToJson(uint8_t mac[6])
{
    CAWMacAddress addr;
...
* 2019/4/17  V1.0    夏章辉     创建
************************************************************************/
Json::Value PacketBase::BufferToJson(uint8_t *buffer, size_t buffersize)
{
...
* 2019/4/17  V1.0    夏章辉     创建
************************************************************************/
Json::Value PacketBase::ByteArrayToJson(char *byte, size_t bytesize)
{
...
void PacketBase::ValueFromJson(Json::Value &jsonvalue, const CAWString &name, uint8_t &outvalue)
{
...
void PacketBase::ValueFromJson(Json::Value &jsonvalue, const CAWString &name, uint16_t  &outvalue)
{
    if (!jsonvalue[name.c_str()].isNull())
    {
        if (jsonvalue[name.c_str()].type() == Json::stringValue)
...
void PacketBase::ValueFromJson(Json::Value &jsonvalue, const CAWString &name, uint32_t &outvalue)
{
    if (!jsonvalue[name.c_str()].isNull())
    {
        if (jsonvalue[name.c_str()].type() == Json::stringValue)
...
void PacketBase::ValueFromJson(Json::Value &jsonvalue, const CAWString &name, uint64_t &outvalue)
{
    if (!jsonvalue[name.c_str()].isNull())
    {
        if (jsonvalue[name.c_str()].type() == Json::stringValue)
        {
            uint64_t retvalue= 0;
            std::string str= jsonvalue[name.c_str()].asString().c_str();
            StrToU64(CAWString(str.c_str()), retvalue);
            outvalue = retvalue;
        }
        else 
        {
...
void PacketBase::ValueFromJson(Json::Value &jsonvalue, const CAWString &name, std::string &output)
{
    if (!jsonvalue[name.c_str()].isNull())
    {
        if (jsonvalue[name.c_str()].type() == Json::stringValue)
...
void PacketBase::ValueFromJson(Json::Value &jsonvalue, const CAWString &name, bool &output)
{
    if (!jsonvalue[name.c_str()].isNull())
    {
        if (jsonvalue[name.c_str()].type() == Json::stringValue)
...
void PacketBase::IPv4FromJson(Json::Value &jsonvalue, const CAWString &name, uint32_t &ipv4output)
{
    if (!jsonvalue[name.c_str()].isNull())
    {
        if (jsonvalue[name.c_str()].type() == Json::stringValue)
...
void PacketBase::IPv6FromJson(Json::Value &jsonvalue, const CAWString &name, uint8_t ipv6output[128])
{
    if (!jsonvalue[name.c_str()].isNull())
    {
        if (jsonvalue[name.c_str()].type() == Json::stringValue)
...
void PacketBase::MacAddressFromJson(Json::Value &jsonvalue, const CAWString &name, uint8_t macaddr[6])
{
    if (!jsonvalue[name.c_str()].isNull())
    {
        if (jsonvalue[name.c_str()].type() == Json::stringValue)
...
void PacketBase::BufferFromJson(Json::Value &jsonvalue, const CAWString &name, uint8_t *buffer, size_t buffersize)
{
    if (!jsonvalue[name.c_str()].isNull())
    {
        if (jsonvalue[name.c_str()].type() == Json::stringValue)
...
void PacketBase::ByteArrayFromJson(Json::Value &jsonvalue, const CAWString &name, char *buffer, size_t buffersize)
{
...
void PacketBase::ValueFromJson_S(Json::Value &jsonvalue, const CAWString &name, uint16_t &outvalue)
{
    if (!jsonvalue[name.c_str()].isNull())
    {
        if (jsonvalue[name.c_str()].type() == Json::stringValue)
...
void PacketBase::ValueFromJson_S(Json::Value &jsonvalue, const CAWString &name, uint8_t &outvalue)
{
    if (!jsonvalue[name.c_str()].isNull())
    {
        if (jsonvalue[name.c_str()].type() == Json::stringValue)
